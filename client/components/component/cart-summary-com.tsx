...
* @see https://v0.dev/t/6Y0LWz82jRE
...
export function cartSummaryCom() {
              ...
              <div className="grid gap-6">
                ...
                <div>
                  ...
                  <div className="grid gap-2">
                    ...
                    <p>
                      <span className="font-semibold">Email:</span> {deliveryInfo.email}
                    </p>
                    <p>
                      <span className="font-semibold">Phone:</span> {deliveryInfo.phone}
                    </p>
                    <p>
                      <span className="font-semibold">Address:</span> {deliveryInfo.address}, {deliveryInfo.city},{" "}
                      {deliveryInfo.state} {deliveryInfo.zip}, {deliveryInfo.country}
                    </p>
                    {deliveryInfo.notes && (
                      <p>
                        <span className="font-semibold">Delivery Notes:</span> {deliveryInfo.notes}
                      </p>
                    )}
                  </div>
                </div>
                  ...
                  <div className="grid gap-2">
                    ...
                    {paymentMethod === "credit_card" && (
                      <>
                        ...
                        <p>
                          <span className="font-semibold">Expiry Date:</span> {cardExpiry}
                        </p>
                      </>
                    )}
                  </div>
